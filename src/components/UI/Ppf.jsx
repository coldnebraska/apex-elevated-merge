...
export default function Ppf() {
    ...
    const [currentPackage, setCurrentPackage] = useState({
        ...
        price: '$599',
        image: '/assets/ppfPackageImages/front_bumper.png',
    ...
    const packageList = [
        ...
        },
        {
            ...
            price: '$1,699',
            image: '/assets/ppfPackageImages/basic.png',
        ...
        },
        {
            ...
            price: '$1,999',
            image: '/assets/ppfPackageImages/full_front.png',
        ...
        },
        {
            ...
            price: '$2,699',
            image: '/assets/ppfPackageImages/track.png',
        ...
        },
        {
            ...
            price: '$5,499',
            image: '/assets/ppfPackageImages/ultimate.png',
        ...
        },
        {
            ...
            price: '$6,499',
            image: '/assets/ppfPackageImages/stealth.png',
        ...
        },
        {
            ...
            price: '$6,499',
            image: '/assets/ppfPackageImages/color_change.png',
        ...
        <div className="service-selector">
            <div className="left">
                {packageList.map((packageItem) => {
                    return (
                        <>
                            <h2 key={packageItem.id} style={packageItem.title == 'Front Bumper' ? {color: 'var(--important-text)'} : {}} id={packageItem.id} onClick={() => {
